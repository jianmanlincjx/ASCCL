...
if __name__=='__main__':
    main()
# sh ./postprocess.sh /data2/JM/code/NED-main/data/test/FrancesMcDormand_t happy_load_pretrain_NED /data2/JM/code/NED-main/renderer_checkpoints_me/McDormand_load_pretrain
